...
import { ArrowLeft, MoveRight, ChevronLeft, ChevronRight, X } from 'lucide-react';
...
export default function ProjectDetail() {
  ...
  const handlePrevImage = () => {
    if (selectedImageIdx !== null) {
      setSelectedImageIdx((prev) => (prev === 0 ? project.images.length - 1 : prev! - 1));
    }
  };

  const handleNextImage = () => {
    if (selectedImageIdx !== null) {
      setSelectedImageIdx((prev) => (prev === project.images.length - 1 ? 0 : prev! + 1));
    }
  };
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            {project.technologies.map((tech, idx) => (
              <span key={idx} className="badge badge-lg badge-primary">{tech}</span>
            ))}
          </div>
        </div>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="flex-1">
                <img 
                  ...
                  className="max-w-full rounded-lg" style={{ justifyContent:"center", alignItems:"center", display:"block", marginLeft:"auto", marginRight:"auto" }}
                />
